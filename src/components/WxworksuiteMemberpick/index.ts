...
export default class WxworksuiteMemberpick extends LitElement {

  static componentName: string = 'wxworksuite-memberpick'
  static register () {
    if (!window.customElements.get(WxworksuiteMemberpick.componentName)) {
      window.customElements.define(WxworksuiteMemberpick.componentName, WxworksuiteMemberpick)
    }
  }
