import { AllowedComponentProps, ComponentCustomProps, VNode, VNodeProps, APP } from 'vue'
...
// declare const Tree: { install (app: App): void } & (new () => {
...
export declare function setNodeById(nodes: TreeNode[], id: TreeNode['id'], node: TreeNode): TreeNode[]
